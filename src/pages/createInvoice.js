...
import { editarInvoices } from "./invoices";
  ...
  function obtenerID() {
    if (customerSelected && customerSelected !== "Select") {
      const customerID = customers.find(
        (customer) =>
          customer.attributes && customer.attributes.name === customerSelected
      );
      if (customerID) {
...
console.log(customerID.id)
  ...
  async function handleSubmit(e) {
    ...
    if (chargesDetails === undefined || chargesDetails.length === 0) {
      toast.error('Invoice details fields are mandatories.',{
        duration:3000,
        style: {
          fontSize: '1.5rem', 
          padding: '16px',  
      ...
      if (respuesta.status === 200) {
        toast.success('Invoices successfully created.',{
          duration: 3000,
          style: {
            fontSize: '2rem', 
            padding: '16px', 
        ...
        <div className={styles.grid_1}>
          ...
          <div className={styles.contenido_left}>
            <p className={styles.inviceNumnber}>
              ...
              <span className={styles.number}>
                {customerSelected === "---Select---" ? "" : invoiceNumber}
              </span>
            </p>
            <div className={styles.pdf}>
              <div className={styles.border1}>
                <FaRegFilePdf size={40} color="#6680a1" />
              </div>

              <div className={styles.border2}>
                <MdEmail size={40} color="#6680a1" />
            ...
            <div className={styles.contenedorSelect}>
              ...
              >
                ...
                {customers?.map((clientes) => {
                  return <option>{clientes.attributes.name}</option>;
                })}
              </select>
            </div>
          ...
          >
            ...
            <div className={styles.cajasContainer}>
              ...
              <div className={styles.caja2}>
                <div className={styles.divInput2}>
                  ...
                  <input
                    type="date"
                    className={`${
                      issueDudateEmpty === true ? styles.redBorder : ""
                    }`}
              ...
              <div
                className={`${styles.caja3} ${
                  descriptionEmpty === true ? styles.redBorder2 : ""
                }`}
              >
